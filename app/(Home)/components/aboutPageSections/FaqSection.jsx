    ...
    <section className="relative py-16 md:py-20 lg:py-24 bg-linear-to-br from-slate-50 via-blue-50 to-indigo-50 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm shadow-lg shadow-purple-500/10 border border-purple-100 mb-4">
          ...
          {/* Main heading */}
          <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6 max-w-4xl mx-auto leading-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          ...
          <div className="space-y-4">
            {faqLeft.map((item, index) => (
              <div
                key={index}
                className={`group bg-white/80 backdrop-blur-sm rounded-xl border transition-all duration-300 overflow-hidden ${
                  openLeft === index
                    ? "shadow-lg shadow-purple-500/20 border-purple-200"
                    : "shadow-md border-slate-200/50 hover:shadow-lg hover:border-purple-100"
                }`}
              >
                <button
                ...
                >
                  ...
                  <div
                    className={`cursor-pointer w-8 h-8 rounded-lg bg-linear-to-br from-indigo-500 to-purple-600 flex items-center justify-center shrink-0 transition-transform duration-300 ${
                ...
                >
                  <div className="px-5 md:px-6 text-slate-600 text-sm md:text-base leading-relaxed">
                    {item.answer}
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-4">
            {faqRight.map((item, index) => (
              <div
                ...
                className={`group bg-white/80 backdrop-blur-sm rounded-xl border transition-all duration-300 overflow-hidden ${
                  openRight === index
                    ? "shadow-lg shadow-indigo-500/20 border-indigo-200"
                    : "shadow-md border-slate-200/50 hover:shadow-lg hover:border-indigo-100"
                }`}
              >
                <button
        ...
        <div className="mt-12 md:mt-16 text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 px-8 py-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-purple-100">
            <div className="w-14 h-14 bg-linear-to-r from-blue-600 via-indigo-600 to-violet-600 rounded-xl flex items-center justify-center shadow-lg">
            ...
            <Link href="/contact">
              <button className="cursor-pointer px-6 py-3 bg-linear-to-r from-blue-600 via-indigo-600 to-violet-600 text-white font-semibold rounded-lg hover:violet-700 transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105 whitespace-nowrap">
                Get Help
              </button>
            </Link>
          </div>

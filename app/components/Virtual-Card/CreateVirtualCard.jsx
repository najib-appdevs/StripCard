...
//   if (s.includes("low") || s.includes("review") || s.includes("unreview"))
//     return "warning";
...
//   if (level === "danger") return "bg-red-100 text-red-800 border-red-200";
...
//   const [fetchError, setFetchError] = useState(null); // only for initial fetch errors

//   const [showUpdateForm, setShowUpdateForm] = useState(false);
//   const [submitting, setSubmitting] = useState(false);

//   // Only these four fields are allowed in update
...
//               {allowedUpdateFields.map((fieldName) => {
...
//                   type="submit"
//                   disabled={submitting}
//                   className="px-7 py-2.5 bg-blue-600 text-white font-medium rounded-xl shadow hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
//                 >
...
//                 </p>
//                 <span
//                   className={`inline-flex px-5 py-2 rounded-full text-base font-semibold border ${getStatusBadgeStyle(
//                     customer_kyc_status,
//                   )}`}
//                 >
...
//                   }`}
//                 >
//                   <p className="leading-relaxed">{customer_low_kyc_text}</p>
//                 </div>
//               )}
...
//                     className="inline-flex items-center px-7 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl shadow transition-all"
//                   >
//                     Update Customer
//                   </button>
//                 </div>

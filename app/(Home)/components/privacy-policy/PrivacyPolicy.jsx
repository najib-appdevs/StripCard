...
export default function PrivacyPolicy() {
  return (
    <section className="relative pt-8 pb-16 md:pt-12 md:pb-20 lg:pt-16 lg:pb-24 bg-linear-to-br from-slate-50 via-blue-50 to-indigo-50">
      {/* Very subtle background decoration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-16 left-12 w-64 h-64 bg-blue-400/5 rounded-full blur-3xl" />
        <div className="absolute bottom-24 right-12 w-80 h-80 bg-indigo-400/5 rounded-full blur-3xl" />
      </div>

      <div className="relative container mx-auto px-5 sm:px-6 lg:px-8 max-w-4xl">
        {/* Main content */}
        <div className="bg-white rounded-xl shadow-lg border border-slate-200/70 overflow-hidden">
          {/* Header */}

          <div className="flex justify-center pt-5 mb-4">
            <div className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/70 backdrop-blur-sm border border-blue-100 shadow-sm">
              <Shield className="w-5 h-5 text-blue-600" />
              <span className="text-base font-semibold bg-linear-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                Privacy Policy
              </span>
            </div>
          </div>
          ...
          <div className="p-6 md:p-8 lg:p-10 text-left md:text-justify">
            <div className="space-y-8 md:space-y-10 prose prose-slate prose-sm sm:prose-base max-w-none">
              <div>
                <h2 className="text-left md:text-center text-xl md:text-2xl font-semibold text-slate-800 mb-4">

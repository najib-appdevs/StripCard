...
function AddMoneyFormSkeleton() {
  return (
    <div className="w-full max-w-3xl rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm animate-pulse">
      {/* Header */}
      <div className="rounded-t-2xl bg-gray-900 dark:bg-gray-950 px-6 py-4">
        <div className="mx-auto h-4 w-32 rounded bg-gray-700 dark:bg-gray-600" />
      </div>
      ...
      <div className="flex flex-col space-y-7 p-6">
        ...
        <div>
          ...
          <div className="flex h-11 w-full rounded-xl bg-gray-200 dark:bg-gray-700" />
        </div>

        {/* Info Box */}
        <div className="space-y-3 rounded-xl bg-gray-100 dark:bg-gray-800/60 px-4 py-4">

    ...
    <div className="mt-6">
      <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
        ...
        <div className="rounded-t-2xl bg-gray-900 dark:bg-gray-950 px-6 py-4">
          <div className="h-5 w-40 rounded bg-gray-700 dark:bg-gray-600 animate-pulse" />
        </div>

        {/* Table header skeleton */}
        <div className="hidden md:grid min-w-[1000px] grid-cols-8 gap-4 px-6 py-3 bg-gray-50 dark:bg-gray-900">
